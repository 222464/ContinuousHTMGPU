...
int main() {
	...
	do {
		...
		agent.step(cs, reward, 0.001f, 0.02f, 0.2f, 0.1f, 0.01f, 1.0f, 1.0f, 0.01f, 0.002f, 0.1f, 0.0f, 5, 6.0f, 100.0f, 0.05f, 0.8f, 0.5f, 0.993f, 0.0f, 0.02f, 0.02f, 10.0f, generator);
