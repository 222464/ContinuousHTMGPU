...
int main() {
	...
	do {
		...
		agent.step(cs, reward, 0.01f, 0.8f, 0.5f, 0.2f, 1.0f, 1.0f, 0.01f, 0.01f, 0.1f, 0.7f, 0.994f, 0.0f, 0.1f, 0.2f, 10.0f, generator);
