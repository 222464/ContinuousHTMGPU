...
int main() {
	...
	do {
		...
		agent.step(cs, reward, 0.05f, 0.05f, 0.005f, 0.05f, 0.02f, 0.01f, 0.01f, 0.1f, 0.0f, 6.0f, 1.0f, 0.01f, 0.01f, 50.0f, 0.05f, 0.05f, 1.0f, 0.001f, 0.05f, 0.7f, 0.992f, 0.0f, 0.05f, 0.05f, generator);
