...
int main() {
	...
	do {
		...
		agent.step(cs, reward, 0.005f, 0.01f, 6.0f, 0.02f, 0.9f, 0.05f, 2.0f, 0.5f, 6.0f, 0.05f, 1.0f, 0.01f, 0.05f, 0.0f, 3, 0.0f, 100.0f, 0.2f, 0.7f, 0.6f, 0.5f, 0.995f, 0.0f, 0.1f, 0.2f, 10.0f, generator);
