...
int main() {
	...
	do {
		...
		agent.step(cs, reward, 0.005f, 0.02f, 0.2f, 0.1f, 0.01f, 1.0f, 1.0f, 0.01f, 0.01f, 0.1f, 0.0f, 5, 100.0f, 100.0f, 0.3f, 0.7f, 0.5f, 0.993f, 0.0f, 0.02f, 0.02f, 10.0f, generator);
