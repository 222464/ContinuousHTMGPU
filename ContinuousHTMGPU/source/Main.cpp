...
int main() {
	...
	agent.createRandom(cs, program, 64, 64, layerDescs, actionMask, -0.2f, 0.2f, 0.01f, 0.1f, generator);
	...
	do {
		...
		agent.step(cs, reward, 0.2f, 0.01f, 0.1f, 0.1f, 0.02f, 0.0f, 4, 0.06f, 0.03f, 0.78f, 0.4f, 0.001f, 0.992f, 0.0f, 0.05f, 0.05f, generator);
